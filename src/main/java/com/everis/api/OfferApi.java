...
public class OfferApi {	
	...
	public List<ApplicationDTO> getOfferApplictions(@PathVariable int offerId){
		
		return offerService.getOfferApplictions(offerId);
	}
	
	@PutMapping("/status")
	public List<String> changeOfferStatus(@RequestParam(name="offerId") int offerId){
		
		return offerService.changeOfferStatus(offerId);
	}
}
